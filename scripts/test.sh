...
PATH=${STATIC_BIN_DIR}/sbin:${PATH} prove -rv t/
PATH=${DYNAMIC_BIN_DIR}/sbin:${PATH} TEST_NGINX_LOAD_MODULES=${DYNAMIC_BIN_DIR}/modules/ngx_http_upstream_jdomain_module.so prove -rv t/
